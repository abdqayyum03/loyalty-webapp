...
const sendPasswordResetEmail = async (email, otp, username) => {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>We received a request to reset the password for your CartRedeem account.</p>
              <p>Enter the code below to set a new password:</p>
              ...
              <div class="warning">
                <strong>⏰ This code is valid for 10 minutes only.</strong><br>
                Do not share this code with anyone. We will never ask you for this code.
              </div>
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM,
      to: email,
      subject: `🔑 Reset Your Password - CartRedeem System`,
      html: htmlContent,
    };
